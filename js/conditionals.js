...
function analyzeColor(color){
    if (color === 'blue'){
         return "Hey isn't blue the best color?";
    } else if (color === 'red') {
...
function analyzeColorSwitch(color){
    switch(color){
        case "blue":
            alert("blue is the color ofr the sky");
            break;
        case "red":
            alert("red is the color of blood");
            break;
        case "orange":
            alert("orange is a nice color and a fruit");
            break;
        case "yellow":
            alert("the Sun it mostly the color yellow");
            break;
        case "green":
            alert("ahh green the beautiful color of money");
            break;
        case "violet":
            alert("huh...violet? nice choice but not my favorite");
            break;
        case "indigo":
...
function calculateTotal(luckyNumber, totalAmount){
    if(luckyNumber === 0){
        ...
        return `you get a %35 discount your total is \$${totalAmount * .35.toFixed(2)}`;
    } else if(luckyNumber === 4){
        return `you get a %50 discount your total is \$${totalAmount * .50.toFixed(2)}`;
    } else if(luckyNumber === 5){
        return `CONGRATS EVERYTHING IS FREE.99, your discount is %100 \$${(0).toFixed(2)}`;
    }
 }
//console.log(calculateTotal(0, 100));
//.log(calculateTotal(1, 100));
